...
require (
	...
	github.com/microsoft/go-mssqldb v1.9.2 // @grafana/grafana-bi-squad
	...
	golang.org/x/mod v0.30.0 // @grafana/grafana-backend-group
...
require (
	...
	github.com/grpc-ecosystem/grpc-gateway/v2 v2.27.4 // @grafana/identity-access-team
